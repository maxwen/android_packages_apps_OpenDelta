		...
		if (onNetworkStateListener != null) {
			...
			if (
				...
				case ConnectivityManager.TYPE_MOBILE:
					...
					case TelephonyManager.NETWORK_TYPE_IDEN:   // 2G ~ 25 kbps
					...
					case TelephonyManager.NETWORK_TYPE_EVDO_B: // 3G ~ 5 Mbps
					...
					case TelephonyManager.NETWORK_TYPE_UMTS:   // 3G ~ 400-7000 kbps
						...
						break;						
					case TelephonyManager.NETWORK_TYPE_HSPAP:  // 4G ~ 10-20 Mbps
